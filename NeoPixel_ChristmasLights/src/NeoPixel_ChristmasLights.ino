...
#define PIXEL_PIN 8  // the NeoPixel control pin
#define LED_COUNT 50 // the total number of LEDs on the string--NeoPixel contructor argument
...
#define SLOW       0 // slows down the transition between values when changing LED RGB values in microseconds
