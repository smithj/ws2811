/*
* Slight modification to use this to control a ws2811 strip using Adafruit NeoPixel library.
*/
...
*/
    for (int l=FIRST_LED; l<=LAST_LED; l++){
       strip.setPixelColor(l, strip.Color(redVal, grnVal, bluVal));
    }
    strip.show();
